...
function get_numH_direct(prob::HJBProblem, grid::Grid)
    ...
    function numH(t, x, V, DxVm, DxVp, params)
        ...
        return prob.H(t, x, V, (DxVm + DxVp) / 2, params)
...
function get_numH_lax_friedrichs(prob::HJBProblem, grid::Grid)
...
function get_ODE_RHS_lax_friedrichs(prob::HJBProblem, grid::Grid)
